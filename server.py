...
if __name__ == '__main__':
    ...
    b0 = Button(p2,textvariable=textForCatch,command=onCatchKeyboard)
    b0.grid(row=0,column=0,padx=30,pady=14,sticky=W)

    b1 = Button(p2,textvariable=textForLock,command=onLockKeyboard)
    b1.grid(row=1,column=0,padx=30,pady=14,sticky=W)

    b2 = Button(p2,textvariable=textForWatchLiveScreen,command=onWatchLiveScreen)
    b2.grid(row=2,column=0,padx=30,pady=14,sticky=W)

    b3 = Button(p2,text="Shutdown",command=onShutdown)
    b3.grid(row=3,column=0,padx=30,pady=14,sticky=W)

    b4 = Button(p2,text="Logout",command=onLogout)
    b4.grid(row=4,column=0,padx=30,pady=14,sticky=W)

    b5 = Button(p2,text="Xem MAC address",command=onGetMacAddress)
    ...
    b7 = Button(p2,text="Xem processes",command=onShowProcesses)
